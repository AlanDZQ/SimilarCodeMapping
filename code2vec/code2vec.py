...
# --load models/java14_model/saved_model_iter8.release --export_code_vectors --test data/my_dataset/my_dataset.test.c2v
# --load models/java14_model/saved_model_iter8.release --export_code_vectors --predict
